...
public class AllIntervalTableBC implements SolverStrategy {
    public String name;


    public AllIntervalTableBC() {
        this.name = "Default Table BC";
    ...
    public static void main(String[] args) {
        SolverStrategy solver = new AllIntervalTableBC();
