...
public class AllIntervalTableAC implements SolverStrategy {
    public String name;


    public AllIntervalTableAC() {
        this.name = "Default Table AC";
    ...
    public static void main(String[] args) {
        SolverStrategy solver = new AllIntervalTableAC();
